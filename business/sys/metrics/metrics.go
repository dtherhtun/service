...
// collecting metrics. The expvar package is already base on a singleton
...
// The metrics value is store in a package level variable since everything
...
// AddPanics increments the errors metric by 1.
