...
# expvarmon -ports=":4000" -endpoint="/debug/vars" -vars="build,requests,goroutines,errors,panics,mem:memstats.Alloc"
#
...
KIND_CLUSTER := opslab-starter-cluster
...
export PROJECT = opslab-starter-kit
CLUSTER := opslab-starter-cluster
DATABASE := opslab-starter-db
ZONE := us-central1-b
